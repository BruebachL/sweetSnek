...
# We need to install the whole project as an editable module within Python 2.7's virtual environment, so that the
# Honey SMB submodule can find the honey log package.
